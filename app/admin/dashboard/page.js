  ...
  return (
    <section>
      ...
      <div className="flex flex-wrap justify-between ml-4">
        ...
        <div className={`${Styles.fourthCard} max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 flex flex-col items-center justify-center `}>
          <svg
            className="w-7 h-7  mb-3"
            aria-hidden="true"
            xmlns="http://www.w3.org/2000/svg"
